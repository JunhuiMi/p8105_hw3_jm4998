...
The dataset contains 15 variables and 1384617 observations. Some key
variables are: “product\_name”, “aisle”, “order\_id”, “user\_id”,
...
instacart %>%
  ...
  top_n(3) %>%
  knitr::kable(title = "Three most popular products",
...
instacart %>%
  ...
  knitr::kable(title = "Mean Order time of two product", 
               col.names =
...
<img src="p8105_hw3_jm4998_files/figure-gfm/unnamed-chunk-8-1.png" width="90%" />
...
accel_data %>%
  ...
  knitr::kable(title = "Total activity for each day")
```
