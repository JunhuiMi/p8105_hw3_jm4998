...
The dataset contains `r length(instacart)` variables and `r length(pull(instacart, order_id))` observations. Some key variables are: "product_name", "aisle", "order_id", "user_id", "order_dow", "order_hour_of_day".
